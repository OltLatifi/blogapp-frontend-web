...
function Navbar() {
    ...
    return (
      <div
        className={`flex flex-col ${
          isMobile ? "space-y-4 text-lg" : "space-x-8 flex-row items-center"
  ...
  function renderDesktopMenu() {
    return <div className="hidden md:flex">{renderNavLinks(false)}</div>;
  }
  ...
  function renderMobileMenu() {
    ...
    return (
      <div
        ref={mobileMenuRef}
        className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white w-full h-full animate-fade-in"
      >
        <button
